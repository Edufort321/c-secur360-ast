# 🚀 GUIDE D'EXÉCUTION MIGRATION C-SECUR360

## 📋 ÉTAPES D'EXÉCUTION MANUELLE

### 🔗 1. ACCÉDEZ À SUPABASE DASHBOARD

**URL:** https://supabase.com/dashboard/project/nzjjgcccxlqhbtpitmpo/editor/17617?schema=public

### 🔧 2. OUVRIR SQL EDITOR

1. Cliquez sur **SQL Editor** dans le menu de gauche
2. Cliquez sur **New Query** 
3. Vous aurez un éditeur SQL vide

### 📝 3. EXÉCUTER LA MIGRATION INCRÉMENTALE

Copiez-collez **EXACTEMENT** le contenu suivant dans l'éditeur SQL:
...
1. Après avoir collé le code, cliquez sur le bouton **"RUN"** ou utilisez `Ctrl+Enter`
2. La migration va s'exécuter (cela peut prendre 30-60 secondes)

### ✅ 5. VÉRIFICATION DU SUCCÈS

**Messages de succès attendus:**
- `✅ C-Secur360 MIGRATION INCRÉMENTALE TERMINÉE!`
- `🔐 Users table updated with RBAC columns`
- `👥 RBAC System: roles, permissions, user_roles`
- `📦 Inventory System: items, locations, stock`

**Vérifiez dans Database > Tables:**
- `roles` (5 rôles de base)
- `permissions` (6 permissions de base)  
- `role_permissions`
- `user_roles`
- `inv_items`, `inv_locations`, `inv_stock`
- `user_profile_payroll`, `vehicles`
- Table `users` avec nouvelles colonnes (tenant_id, totp_secret, etc.)

### 🚨 6. EN CAS D'ERREUR

Si vous voyez des erreurs:
1. **"relation already exists"** → C'est normal, ignorez
2. **"column already exists"** → C'est normal, ignorez  
3. **Autres erreurs** → Notez-les et continuez, la plupart des tables auront été créées

### 📋 7. APRÈS L'EXÉCUTION

Une fois terminé, nous pourrons:
- ✅ Vérifier les policies RLS
- ✅ Tester les fonctions utilitaires
- ✅ Implémenter l'interface mobile
- ✅ Activer le système QR scanning

---

## 🎯 RÉSULTAT ATTENDU

**30+ nouvelles tables créées**
**Structure users existante préservée et étoffée**  
**Système RBAC complet opérationnel**
**Base inventaire QR-First prête**
**Foundation ERP/timesheet établie**