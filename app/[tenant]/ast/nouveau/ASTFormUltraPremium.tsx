                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                  <div className="bg-blue-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {formData.pointsIsolement?.length || 0}
                    </div>
                    <div className="text-sm text-blue-700">Points Total</div>
                  </div>
                  <div className="bg-yellow-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-yellow-600">
                      {formData.pointsIsolement?.filter(p => p.type === 'electrical').length || 0}
                    </div>
                    <div className="text-sm text-yellow-700">Électrique</div>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-green-600">
                      {formData.pointsIsolement?.filter(p => p.type === 'mechanical').length || 0}
                    </div>
                    <div className="text-sm text-green-700">Mécanique</div>
                  </div>
                  <div className="bg-purple-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-purple-600">
                      {formData.pointsIsolement?.filter(p => p.isole).length || 0}
                    </div>
                    <div className="text-sm text-purple-700">Isolés</div>
                  </div>
                </div>
                ...
                {formData.pointsIsolement?.map((point, index) => (
                  <div key={index} className="bg-gray-50 p-6 rounded-lg border">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={point.source}
                          onChange={(e) => updateIsolationPoint(index, 'source', e.target.value)}
                          className="input-field"
                      ...
                      <div>
                        ...
                        <select
                          value={point.type}
                          onChange={(e) => updateIsolationPoint(index, 'type', e.target.value)}
                          className="input-field"
                        >
                      ...
                      <div>
                        ...
                        <select
                          value={point.methode}
                          onChange={(e) => updateIsolationPoint(index, 'methode', e.target.value)}
                          className="input-field"
                        >
                          <option value="">Sélectionner</option>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateIsolationPoint(index, 'responsable', e.target.value)}
                          className="input-field"
                    ...
                    <div className="mb-4">
                      <CustomCheckbox
                        checked={point.isole}
                        onChange={(checked) => updateIsolationPoint(index, 'isole', checked)}
                        label="Point d'isolement vérifié et isolé"
                        variant="success"
                      />
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <PhotoCarousel 
                        photos={point.photos || []}
                        onAddPhoto={(stepId, file) => addPhotoToIsolationPoint(index, file)}
                        onRemovePhoto={(stepId, photoId) => removePhotoFromIsolationPoint(index, parseInt(photoId))}
                        stepId={`isolation-${index}`}
                        maxPhotos={5}
                      />
                    </div>
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-green-600">
                      {formData.equipe?.filter(m => m.qualifications?.length > 0).length || 0}
                    </div>
                    <div className="text-sm text-green-700">Qualifiés</div>
                  </div>
                  <div className="bg-yellow-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-yellow-600">
                      {formData.equipe?.reduce((sum, m) => sum + (parseInt(m.experience) || 0), 0) || 0}
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={member.poste}
                          onChange={(e) => updateMember(index, 'poste', e.target.value)}
                          className="input-field"
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={member.entreprise}
                          onChange={(e) => updateMember(index, 'entreprise', e.target.value)}
                          className="input-field"
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <input
                          type="text"
                          value={member.roleSpecifique}
                          onChange={(e) => updateMember(index, 'roleSpecifique', e.target.value)}
                          className="input-field"
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 rounded-lg text-white">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold">{formData.equipe?.length || 0}</div>
                      <div className="text-sm opacity-90">Personnes</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold">
                        {formData.dangersIdentifies?.filter(d => d.present && d.niveauRisque === 'Élevé').length || 0}
                      </div>
                      <div className="text-sm opacity-90">Risques Élevés</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold">
                        {formData.equipementsSecurite?.filter(e => e.utilise).length || 0}
                      </div>
                      <div className="text-sm opacity-90">Équipements</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold">{formData.pointsIsolement?.length || 0}</div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <CustomCheckbox
                      checked={formData.validations?.risquesEvalues || false}
                      onChange={(checked) => setFormData(prev => ({
                        ...prev,
                        validations: { ...prev.validations, risquesEvalues: checked }
                      }))}
                      label="Tous les risques ont été identifiés et des mesures de contrôle appropriées sont en place"
                      variant={formData.validations?.risquesEvalues ? 'success' : 'default'}
                    />
                    
                    <CustomCheckbox
                      checked={formData.validations?.equipementVerifie || false}
                      onChange={(checked) => setFormData(prev => ({
                        ...prev,
                        validations: { ...prev.validations, equipementVerifie: checked }
                      }))}
                      label="Tous les équipements de sécurité requis sont disponibles et en bon état"
                      variant={formData.validations?.equipementVerifie ? 'success' : 'default'}
                    />
                    
                    <CustomCheckbox
                      checked={formData.validations?.equipeFormee || false}
                      onChange={(checked) => setFormData(prev => ({
                        ...prev,
                        validations: { ...prev.validations, equipeFormee: checked }
                      }))}
                      label="L'équipe a été informée des risques et des procédures de sécurité"
                      variant={formData.validations?.equipeFormee ? 'success' : 'default'}
                    />
                    
                    <CustomCheckbox
                      checked={formData.validations?.proceduresComprises || false}
                      onChange={(checked) => setFormData(prev => ({
                        ...prev,
                        validations: { ...prev.validations, proceduresComprises: checked }
                      }))}
                      label="Les procédures d'urgence sont définies et comprises par tous"
                      variant={formData.validations?.proceduresComprises ? 'success' : 'default'}
                    />
                    
                    <CustomCheckbox
                      checked={formData.validations?.infoComplete || false}
                      onChange={(checked) => setFormData(prev => ({
                        ...prev,
                        validations: { ...prev.validations, infoComplete: checked }
                      }))}
                      label="Cette AST a été approuvée par l'autorité compétente"
                      variant={formData.validations?.infoComplete ? 'success' : 'default'}
                    />
                  </div>
                </div>
                    ...
                    <div key={index}>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              newApprobations[index] = { ...newApprobations[index], nom: e.target.value };
                              setFormData(prev => ({ ...prev, approbations: newApprobations }));
                            }}
                            className="input-field"
                            placeholder={`Nom complet du ${approbation.role.toLowerCase()}`}
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const newApprobations = [...(formData.approbations || [])];
                              newApprobations[index] = { ...newApprobations[index], dateHeure: e.target.value };
                              setFormData(prev => ({ ...prev, approbations: newApprobations }));
                            }}
                            className="input-field"
                          />
                        ...
                        <CustomCheckbox
                          ...
                          onChange={(checked) => {
                            const newApprobations = [...(formData.approbations || [])];
                            newApprobations[index] = { ...newApprobations[index], approuve: checked };
                            setFormData(prev => ({ ...prev, approbations: newApprobations }));
                          }}
                          label="Approuvé"
                          variant="success"
