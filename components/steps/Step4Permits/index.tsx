...
const ConfinedSpace: React.FC<ConfinedSpaceProps> = ({
  ...
  const [selectedProvince, setSelectedProvince] = useState<ProvinceCode>(province as ProvinceCode);
  ...
  useEffect(() => {
    if (!permitData.permit_number && selectedProvince) {
  ...
  }, [selectedProvince, permitData.permit_number]);
