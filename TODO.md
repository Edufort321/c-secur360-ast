...
- **Agent 3 (Affiliation)** : ✅#51, ✅#63 mergés · reste **#69** (paiements de commission : marquer payé + historique + lien compta ; migration 125). Zone : `app/admin/commissions/**`, `app/admin/vendors/**`, `app/api/admin/affiliate-*`, `lib/affiliate*`, migration 125.
