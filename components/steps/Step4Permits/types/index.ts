// components/steps/Step4Permits/types/index.ts - TYPES UNIFIÉS SANS DOUBLONS
...
// =================== EXPORTS ORGANISÉS (SANS CONFLIT) ===================
// Note: Tous les types sont déjà exportés individuellement ci-dessus
// Pas de re-export groupé pour éviter les conflits
