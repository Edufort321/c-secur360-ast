...
import { WorkLocation, LockoutPoint, LockoutPhoto, LocationStats } from './types';
...
function Step1ProjectInfo({ formData, onDataChange, language, tenant, errors = {}, userId, userRole }: Step1ProjectInfoProps) {
  ...
  // =================== STATE MANAGEMENT ===================
  const { localData, setLocalData, astNumber, setAstNumber, copied, setCopied } =
    useProjectInfoState({
      formData,
      projectInfo,
      workLocations,
