    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
          <div className="text-2xl font-bold text-blue-600">{permitStats.total}</div>
          <div className="text-sm text-gray-600">{t.totalPermits}</div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
          <div className="text-2xl font-bold text-green-600">{permitStats.approved}</div>
          <div className="text-sm text-gray-600">{t.approvedPermits}</div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
          <div className="text-2xl font-bold text-yellow-600">{permitStats.pending}</div>
          <div className="text-sm text-gray-600">{t.pendingPermits}</div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
          <div className="text-2xl font-bold text-red-600">{permitStats.expired}</div>
          <div className="text-sm text-gray-600">{t.expiredPermits}</div>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
          <div className="text-2xl font-bold text-purple-600">${permitStats.totalCost}</div>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <h4 className="font-medium text-gray-900">{permit.title}</h4>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <label className="flex items-center space-x-3">
              ...
              />
              <span className="text-sm font-medium text-gray-700">{t.notifyExpiry}</span>
            </label>
            ...
            <label className="flex items-center space-x-3">
              <input
                ...
                className="w-4 h-4 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500"
              />
              <span className="text-sm font-medium text-gray-700">{t.escalationRules}</span>
            </label>
                ...
                {[1, 3, 7, 14, 30].map(days => (
                  <label key={days} className="flex items-center space-x-2">
                    <input
                      ...
                      className="w-4 h-4 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500"
                    />
                    <span className="text-sm text-gray-700">{days}j</span>
                  </label>
                ))}
              </div>
            </div>
