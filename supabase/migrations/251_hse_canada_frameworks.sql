...
--    event_code : FATALITY (décès) · SERIOUS_INJURY (blessure grave/critique).
...
from (values
  ...
  ('CA_FED','SERIOUS_INJURY', 'Blessure invalidante — avis immédiat',     'Disabling injury — immediate notice',   0, 24,   'RSSTC 15.5-15.8 / CCT partie II'),
  ('OHS_ON','FATALITY',       'Décès — avis immédiat, rapport écrit 48 h','Death — immediate notice, 48 h written report', 0, 48, 'OHSA art. 51'),
  ('OHS_ON','SERIOUS_INJURY', 'Blessure critique — avis immédiat, rapport 48 h','Critical injury — immediate notice, 48 h report', 0, 48, 'OHSA art. 51'),
  ...
  ('OHS_AB','SERIOUS_INJURY', 'Incident potentiellement grave — avis immédiat','Potentially serious incident — immediate notice', 0, 72, 'OHS Act AB art. 33'),
  ...
  ('OHS_BC','SERIOUS_INJURY', 'Blessure grave — avis immédiat WorkSafeBC','Serious injury — immediate WorkSafeBC notice', 0, 72, 'WCA C.-B. art. 172/173'),
  ('OHS_MB','FATALITY',       'Décès — avis immédiat',                    'Death — immediate notice',              0, null, 'Workplace Safety and Health Act MB'),
  ('OHS_MB','SERIOUS_INJURY', 'Blessure grave — avis immédiat',           'Serious injury — immediate notice',     0, null, 'Workplace Safety and Health Act MB'),
  ('OHS_NB','FATALITY',       'Décès — avis immédiat',                    'Death — immediate notice',              0, null, 'OHS Act NB'),
  ('OHS_NB','SERIOUS_INJURY', 'Accident grave — avis immédiat',           'Serious accident — immediate notice',   0, null, 'OHS Act NB'),
  ('OHS_NL','FATALITY',       'Décès — avis immédiat',                    'Death — immediate notice',              0, null, 'OHS Act NL'),
  ('OHS_NL','SERIOUS_INJURY', 'Blessure grave — avis immédiat',           'Serious injury — immediate notice',     0, null, 'OHS Act NL'),
  ('OHS_NS','FATALITY',       'Décès — avis immédiat',                    'Death — immediate notice',              0, null, 'OHS Act NS'),
  ('OHS_NS','SERIOUS_INJURY', 'Blessure grave — avis immédiat',           'Serious injury — immediate notice',     0, null, 'OHS Act NS'),
  ('OHS_PE','FATALITY',       'Décès — avis immédiat',                    'Death — immediate notice',              0, null, 'OHS Act PE'),
  ('OHS_PE','SERIOUS_INJURY', 'Blessure grave — avis immédiat',           'Serious injury — immediate notice',     0, null, 'OHS Act PE'),
  ('OHS_SK','FATALITY',       'Décès — avis immédiat',                    'Death — immediate notice',              0, null, 'Saskatchewan Employment Act, partie III'),
  ('OHS_SK','SERIOUS_INJURY', 'Blessure grave (« serious injury ») — avis immédiat','Serious injury — immediate notice', 0, null, 'Saskatchewan Employment Act, partie III'),
  ('OHS_NT','FATALITY',       'Décès — avis immédiat (WSCC)',             'Death — immediate notice (WSCC)',       0, null, 'Safety Act NT (WSCC)'),
  ('OHS_NT','SERIOUS_INJURY', 'Blessure grave — avis immédiat (WSCC)',    'Serious injury — immediate notice (WSCC)', 0, null, 'Safety Act NT (WSCC)'),
  ('OHS_NU','FATALITY',       'Décès — avis immédiat (WSCC)',             'Death — immediate notice (WSCC)',       0, null, 'Safety Act NU (WSCC)'),
  ('OHS_NU','SERIOUS_INJURY', 'Blessure grave — avis immédiat (WSCC)',    'Serious injury — immediate notice (WSCC)', 0, null, 'Safety Act NU (WSCC)'),
  ('OHS_YT','FATALITY',       'Décès — avis immédiat (YWCHSB)',           'Death — immediate notice (YWCHSB)',     0, null, 'OHS Act YT (YWCHSB)'),
  ('OHS_YT','SERIOUS_INJURY', 'Blessure grave — avis immédiat (YWCHSB)',  'Serious injury — immediate notice (YWCHSB)', 0, null, 'OHS Act YT (YWCHSB)')
